...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *r1 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemRefresh target:self action:@selector(my)];
    UIBarButtonItem *r2 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemPlay target:self action:@selector(loading)];

//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemRefresh target:self action:@selector(my)];
...
//    Application *app = [[self filteredApps] objectAtIndex:1];
    BaseNoDataViewController *controller = [[BaseNoDataViewController alloc] init];
